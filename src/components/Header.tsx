          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={onLogout}
                  className="p-3 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-2xl transition-all duration-300 cursor-pointer hover:scale-105 active:scale-95"
                  style={{ 
                    pointerEvents: 'auto',
                    zIndex: 9999,
                    position: 'relative'
